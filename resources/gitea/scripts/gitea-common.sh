...
load_gitea_env() {
  ...
  GITEA_ACTIONS_ENABLED="${GITEA_ACTIONS_ENABLED:-true}"
  GITEA_BOOTSTRAP_REPO_ENABLED="${GITEA_BOOTSTRAP_REPO_ENABLED:-true}"
  GITEA_BOOTSTRAP_REPO_NAME="${GITEA_BOOTSTRAP_REPO_NAME:-vmctl}"
  GITEA_BOOTSTRAP_REPO_PRIVATE="${GITEA_BOOTSTRAP_REPO_PRIVATE:-true}"
  GITEA_BOOTSTRAP_SECRETS_ENABLED="${GITEA_BOOTSTRAP_SECRETS_ENABLED:-false}"
  GITEA_BOOTSTRAP_SECRET_PROXMOX_TOKEN_ID="${GITEA_BOOTSTRAP_SECRET_PROXMOX_TOKEN_ID:-}"
  GITEA_BOOTSTRAP_SECRET_PROXMOX_TOKEN_SECRET="${GITEA_BOOTSTRAP_SECRET_PROXMOX_TOKEN_SECRET:-}"
  GITEA_BOOTSTRAP_SECRET_TAILSCALE_AUTH_KEY="${GITEA_BOOTSTRAP_SECRET_TAILSCALE_AUTH_KEY:-}"
  GITEA_BOOTSTRAP_SECRET_DEFAULT_SSH_PRIVATE_KEY="${GITEA_BOOTSTRAP_SECRET_DEFAULT_SSH_PRIVATE_KEY:-}"
  GITEA_BOOTSTRAP_SECRET_DEFAULT_SSH_PUBLIC_KEY="${GITEA_BOOTSTRAP_SECRET_DEFAULT_SSH_PUBLIC_KEY:-}"
  ...
  export GITEA_ACTIONS_ENABLED GITEA_BOOTSTRAP_REPO_ENABLED GITEA_BOOTSTRAP_REPO_NAME
  export GITEA_BOOTSTRAP_REPO_PRIVATE GITEA_BOOTSTRAP_SECRETS_ENABLED
  export GITEA_BOOTSTRAP_SECRET_PROXMOX_TOKEN_ID GITEA_BOOTSTRAP_SECRET_PROXMOX_TOKEN_SECRET
  export GITEA_BOOTSTRAP_SECRET_TAILSCALE_AUTH_KEY
  export GITEA_BOOTSTRAP_SECRET_DEFAULT_SSH_PRIVATE_KEY
  export GITEA_BOOTSTRAP_SECRET_DEFAULT_SSH_PUBLIC_KEY
}
